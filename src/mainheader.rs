// Imports
use crate::{appmenu::RnAppMenu, appwindow::RnAppWindow};
use gtk::{
    glib, prelude::*, subclass::prelude::*, Box, CompositeTemplate,
    EventControllerLegacy, Label, ToggleButton, Widget,
};
...
mod imp {
    ...
    #[template(resource = "/com/github/linruohan/mytool/ui/mainheader.ui")]
